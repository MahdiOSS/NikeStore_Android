...
fun openUrlInCustomTab(context: Context, url: String) {
 ...
 fun <T : Any> Single<T>.threadNetWortRequest() : Single<T> = subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread())
 fun Completable.threadNetWortRequest() : Completable = subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread())
